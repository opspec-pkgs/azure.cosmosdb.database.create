[![build](https://github.com/opspec-pkgs/azure.cosmosdb.database.create/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/azure.cosmosdb.database.create/actions/workflows/build.yml)
